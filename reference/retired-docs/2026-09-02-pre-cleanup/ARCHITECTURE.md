...
- **Build setup:** superseded; see the current `AGENTS.md` and `tools/setup-nuget.sh`.
...
petalfell.csproj
NuGet.config    generated by tools/setup-nuget.sh — see current build instructions
```
